...
public enum ActivityType {
    HTTP, DATAEXTRACTION, DB, SSH, TRANSFORM, VALIDATION, DATAENRICHER, INITIALIZE, JSONVALIDATION, DIRECTORYREADER;
    ...
    public static ActivityType from(String value) {
        ...
        throw new IllegalArgumentException("Unknown activity type: '" + value
                + "'. Valid values: HTTP, DATAEXTRACTION, DB, SSH, TRANSFORM, VALIDATION, DATAENRICHER, JSONVALIDATION, DIRECTORYREADER");
    }
}
